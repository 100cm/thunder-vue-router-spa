...
/***/ function(module, exports) {
	...
	module.exports = "\n<div >\n    <h1>基础配置</h1>\n    <blockquote>\n        <p>极速的开发. 简易的配置</p>\n    </blockquote>\n    <p>Thunder 目前暂定使用默认配置 后续的配置会持续补上.</p>\n    <figure class=\"highlight html\">\n        <pre>\n\npublic class App implements Lightning {\n    @Override\n    public void init(Thunder thunder) {\n        //打开数据库\n        DB.open(\"com.mysql.jdbc.Driver\", \"jdbc:mysql://127.0.0.1/test\", \"root\", \"root\");\n        //默认的注解扫描包 不填写都为全部扫描.\n        thunder.setAppBasePackage(\"\");\n        //增加单条post 路由 指定指向welcome类下的create方法\n        thunder.addPostRoute(\"/welcome/create\",\"create\",new Welcome());\n        thunder.addResource(\"demo\",new Welcome());\n    }\n}\n        </pre>\n\n    </figure>\n<p> 当前默认的页面模板存放位置为WEB-INF下. 当前默认不渲染css 等静态文件 需要在 web.xml增加默认的servlet渲染</p>\n    <figure class=\"highlight html\">\n        <pre>\n &lt;servlet-mapping&gt;\n    &lt;servlet-name&gt;default&lt;/servlet-name&gt;\n    &lt;url-pattern&gt;*.jpg&lt;/url-pattern&gt;\n  &lt;/servlet-mapping&gt;\n  &lt;servlet-mapping&gt;\n    &lt;servlet-name&gt;default&lt;/servlet-name&gt;\n    &lt;url-pattern&gt;*.js&lt;/url-pattern&gt;\n  &lt;/servlet-mapping&gt;\n  &lt;servlet-mapping&gt;\n    &lt;servlet-name&gt;default&lt;/servlet-name&gt;\n    &lt;url-pattern&gt;*.css&lt;/url-pattern&gt;\n  &lt;/servlet-mapping&gt;\n        </pre>\n    </figure>\n</div>\n";

/***/ },
/* 74 */
/***/ function(module, exports) {

	module.exports = "\n<div >\n    <h1>开始使用!</h1>\n    <h3>Hello world</h3>\n    <p>非 maven项目 - 首先克隆源码并且进行打包,导入jar包 进行web.xml进行配置 <br>(使用idea的同学需要同时导入servlet-api这个jar包 eclipse或myeclipse的同学直接导入jar包即可.关于后续的maven jar包发暂定) </p>\n\n    <figure class=\"highlight html\">\n    <pre>\n   &lt;servlet&gt;\n        &lt;servlet-name&gt;thunder&lt;/servlet-name&gt;\n        &lt;servlet-class&gt;com.thunder.web.ThunderDispatcher&lt;/servlet-class&gt;\n        &lt;init-param&gt;\n            &lt;param-name&gt;lighting&lt;/param-name&gt;\n            &lt;param-value&gt;App&lt;/param-value&gt;\n        &lt;/init-param&gt;\n     &lt;load-on-startup&gt;1&lt;/load-on-startup&gt;\n    &lt;/servlet&gt;\n    </pre>\n    </figure>\n\n    <p>在根目录下创建App.java 并且继承lighting接口</p>\n    <figure class=\"highlight html\">\n        <pre>\n    public class App implements Lightning{\n        public void init(Thunder thunder) {\n\n            }\n       }\n        </pre>\n\n    </figure>\n\n    <p>这样我们第一个thunder应用就完成啦！(后续会做更多的配置)</p>\n</div>\n";

/***/ },
/* 75 */
/***/ function(module, exports) {

	module.exports = "\n<div >\n    <h1>欢迎使用thunder</h1>\n    <blockquote>\n        <p>一个微型mvc 框架 轻巧,快速为一体。可以用作快速开发原型。\n        </p>\n    </blockquote>\n    <h3>Thunder有哪些功能?</h3>\n    <ul>\n        <li>集成了轻量级的Aop 动态代理.</li>\n        <li>集成了轻量级Ioc 不用再为 new 对象的另外一半而烦躁( =new duixiang() )</li>\n        <li>路由型过滤器,无性能损耗,lamda表达式让你的代码时尚时尚更时尚</li>\n        <li>集成了轻量级伪ActiveRecord 。对service厌烦的同学在原型里和Service层说88吧！(虽然这样做并不是很好)</li>\n        <li>Restful风格的路由。多路由自动生成。告别重复编程烦恼（目前还是残疾的 后续会优化）。</li>\n        <li>支持jdk1.6 (AOP 只支持1.8+) 以及更高版本</li>\n    </ul>\n</div>\n";
...
/***/ function(module, exports) {
	...
	module.exports = "<div>\n<h1>其他</h1>\n<blockquote>哈哈哈 藏这么深还是被你发现了</blockquote>\n\n<p><a href=\"https://github.com/icepoint0\">我的Github 地址</a><br>\n我的邮箱 351711778@qq.com<br>\n我的QQ 同上<br>\n本人目前在上海 2016年6月毕业<br>\n希望有朋友能够和我一起学习.提出更多建议 有问题可以邮件提出.</p>\n</div>";

/***/ },
/* 80 */
/***/ function(module, exports) {

	module.exports = "<div>\n    <h1>这个你都能找的到!</h1>\n    <blockquote>其实也没什么特殊的技巧.</blockquote>\n</div>";
